 Feature: Test for How it works page
	
	Scenario: View How it works header elements
	  Given the user is on the How it works page
	...
	Scenario: View Who is eligible section cards elements
	  Given the user is on the How it works page
	  Then check the following data of main content first card is correct
		| Title          |  For you                                         |
