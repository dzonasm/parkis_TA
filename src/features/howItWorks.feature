Feature: Test for howItWorks page

  	Scenario: View howItWorks header elements 
    	Given the user is on the howItWorks page
	...
	Scenario: View How it works our offerings section elements
		Given the user is on the howItWorks page
	...
	Scenario: View Who is eligible section first cards elements
		Given the user is on the howItWorks page
		Then check the following data of main content who is eligible section (0) card is correct
			| Title          | For you                                          |
	...
	Scenario: View Who is eligible section second card elements
		Given the user is on the howItWorks page
	  	Then check the following data of main content who is eligible section (1) card is correct
	...
	Scenario: View Who is eligible section third card elements
		Given the user is on the howItWorks page
	  	Then check the following data of main content who is eligible section (2) card is correct
